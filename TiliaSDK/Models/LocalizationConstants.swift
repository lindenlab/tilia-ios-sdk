...
enum L {
  ...
  static let tosAcceptDescription = "tosAcceptDescription".localized
  ...
  static let errorTosContentTitle = "errorTosContentTitle".localized
  static let errorTosContentMessage = "errorTosContentMessage".localized
  ...
  static let youPaid = "youPaid".localized
  static let youReceived = "youReceived".localized
