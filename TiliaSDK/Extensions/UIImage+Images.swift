...
extension UIImage {
  ...
  static let payPalIcon = UIImage(str: "payPalIcon")
  static let buyerPurchaseIcon = UIImage(str: "buyerPurchaseIcon")
  static let sellerPurchaseIcon = UIImage(str: "sellerPurchaseIcon")
